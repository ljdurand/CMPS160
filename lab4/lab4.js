...
////        verticesList.push(vertices[i+1]);
////        verticesList.push(vertices[i+2]);
//  //  }
//    
//    
//  //  for(var i = 0; i < indexes.length; i+=3){
//        indexesList.push(indexes);
//        indexesList.push(indexes[i+1]);
//        indexesList.push(indexes[i+2]);
 //   }
    
    // console.log("verticesList: " + verticesList);
    // console.log("verticesList length: " + verticesList.length);
     ...
     if(right_clicked) {
       // console.log("rotate: " + rotate);
        ...
        if(pickedObject == null && pan == true){
            ...
            if(panPreviewY < -400) panPreviewY = -400;
//            orthoLeft = -(500+ lookAtX);
//            orthoRight = 500 + lookAtX;
//            orthoBottom = -(500 + lookAtY);
//            orthoTop = 500 + lookAtY;
//            if(lookAtX > 0){
//                orthoLeft -= 10;
//                orthoRight += 10;
//            }else if(lookAtX <= 0){
